...
KERNEL_BOOTIMAGE_CMDLINE = bootopt=64S3,32N2,64N2 datapart=/dev/disk/by-partlabel/userdata androidboot.selinux=permissive buildvariant=userdebug cgroup_disable=pressure
...
# Defconfig to use
KERNEL_DEFCONFIG = akita_defconfig
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/mediatek/akita_row_call.dtbo
