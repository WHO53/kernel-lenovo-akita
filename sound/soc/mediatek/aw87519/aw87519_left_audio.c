 ...
 * aw87519 marco
 ******************************************************************************/
#define AW87519_LEFT_I2C_NAME    "AW87519_LEFT_PA"
#define AW87519_LEFT_DRIVER_VERSION	"v1.0.7"
...
unsigned char aw87519_left_audio_speaker(void);
unsigned char aw87519_left_audio_off(void);
unsigned char aw87519_left_audio_hvload(void);
/*******************************************************************************
* aw87519 variable
******************************************************************************/
...
static char *aw87519_kspk_name = "aw87519_left_spk_anna.bin";
				...
				size_t len)
{
	...
	if (state == 0)
		...
		aw87519_left_audio_receiver();
	else if (state == 3)
		aw87519_left_audio_hvload();
	else
		aw87519_left_audio_off();
...
static int __init aw87519_pa_init(void)
{
	...
	pr_debug("%s enter\n", __func__);
	pr_debug("%s: driver version: %s\n", __func__, AW87519_LEFT_DRIVER_VERSION);
